...
$('#InsertVideo').click(function(){
  ...
  //$('.ql-align-center').width($('#video_width').val()).height($('#video_height').val());
  quill.formatText(currentIdx, 0,'width', $('#video_width').val());
  quill.formatText(currentIdx, 0,'height', $('#video_height').val());
  $('#vcls')[0].click();
});
