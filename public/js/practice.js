...
$(function () {
  ...
  if (document.getElementById("audio-upload") != null) {
...
function wordList() {
  ...
  if ($("#cfnt2").val() != "")
    selectedC = "<span style='font-size: 1.5em;' class='ql-font-" + $("#cfnt2").val() + "'>" + selectedC + "</span>";
  document.querySelector("#snow-container").children[0].innerHTML =
    html +
          ...
          if (typeof simpleData[i].nodes[j].nodes !== "object") {
            ...
            simpleData[i].nodes[j].nodes.push({
              text:
                ...
                etymologies +
                cptxtf +
                JSON.stringify(etymologies[0]).replace(/\"/g, "").replace(/'/g, "‡") +
                cptxtb,
              selectable: true,
            });
          } else {
          ...
          if (typeof definitions !== "undefined") {
            ...
            simpleData[i].nodes[j].nodes.push({
              text:
                ...
                "</b>" +
                cptxtf +
                JSON.stringify(definitions[0]).replace(/\"/g, "").replace(/'/g, "‡") +
                cptxtb,
              selectable: true,
            });
            ...
            for (let m = 0; m < examples.length; m++) {
              ...
              simpleData[i].nodes[j].nodes.push({
                text:
                  ...
                  "</i>" +
                  cptxtf +
                  JSON.stringify(examples[m].text).replace(/\"/g, "").replace(/'/g, "‡") +
                  cptxtb,
                selectable: true,
              });
              ssIdx = simpleData[i].nodes[j].nodes.length - 1;
          ...
          if (typeof shortDefinitions !== "undefined") {
            ...
            simpleData[i].nodes[j].nodes.push({
              text:
                ...
                shortDefinitions +
                cptxtf +
                JSON.stringify(shortDefinitions[0]).replace(/\"/g, "").replace(/'/g, "‡") +
                cptxtb,
              selectable: true,
            });
            ssIdx = simpleData[i].nodes[j].nodes.length - 1;
            ...
            for (let m = 0; m < notes.length; m++) {
              simpleData[i].nodes[j].nodes.push({
                text:
                  ...
                  ")" +
                  cptxtf +
                  JSON.stringify(notes[m].text).replace(/\"/g, "").replace(/'/g, "‡") +
                  " (" +
                  JSON.stringify(notes[m].type).replace(/\"/g, "").replace(/'/g, "‡") +
                  ")" +
                  cptxtb,
                selectable: true,
              });
              ...
              if (typeof subsenses_definitions !== "undefined") {
                ...
                simpleData[i].nodes[j].nodes[ssIdx].nodes.push({
                  text:
                    ...
                    "</b>" +
                    cptxtf +
                    JSON.stringify(subsenses_definitions[0]).replace(/\"/g, "").replace(/'/g, "‡") +
                    cptxtb,
                  selectable: true,
                });
              }
                ...
                for (let n = 0; n < subsenses_examples.length; n++) {
                  ...
                  simpleData[i].nodes[j].nodes[ssIdx].nodes.push({
                    text:
                      ...
                      "</i>" +
                      cptxtf +
                      JSON.stringify(subsenses_examples[n].text).replace(/\"/g, "").replace(/'/g, "‡") +
                      cptxtb,
                    selectable: true,
                  });
                }
            ...
            for (let m = 0; m < subsenses.length; m++) {
              ...
              if (typeof subsenses_synonyms === "object") {
                for (let n = 0; n < subsenses_synonyms.length; n++) {
                  simpleData[i].nodes[j].nodes[ssIdx].nodes.push({
                    text: "synonym: " + "<b>" + subsenses_synonyms[n].text + "</b>",
                  });
                }
              }
            }
